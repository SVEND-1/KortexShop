...
import org.example.kortex.users.api.dto.CourierDTOMapper;
...
public class CourierController {
    ...
    public ResponseEntity<?> setStatus(@PathVariable Long id, @RequestParam("status") Order.OrderStatus status) {
        try {
            ...
            log.info("" + status);
